---
title: 'The Craft of Effective Digital Vision Boarding'
date: 2026-04-06 00:00:00 -07:00
tags:
- Inner Work 
- Mindful Living
- Creative Business
...
By the way this post is also a companion to my podcast episode [The Craft of Digital Vision Boarding](https://arcadiapage.substack.com/p/the-craft-of-digital-vision-boarding). So if you don’t feel like reading, you can listen to it [here](https://arcadiapage.substack.com/p/the-craft-of-digital-vision-boarding).
...
You could even create an ikigai diagram and use the results from that to build a vision board that reflects your current life’s purpose. I go deeper into what an ikigai diagram is and how to use it effectively in my post [I Used Ikigai to Find the Purpose of My Creative Business. This is What Happened.](https://arcadiapage.com/2026-02-20-ikigai-for-creative-business/)
...
Also on my vision board for this year are the words “Taking Care of Yourself is Productive.” In February of this year, I managed to finally finish getting my [Master Self-care Coaching certification](https://arcadia.thoughts.page/#1771901894). I’ve been trying to get this certification for years, but kept experiencing blocks in the process. 
...
My favorite app for making a vision board is [Pinterest Shuffles](https://www.shffls.com/). It’s quick, easy and artsy. All the words and images needed are easy to find using search, it doesn’t take much skill to arrange the graphics, and once you’re done, downloading it as a phone wallpaper only takes a button click. It’s crazy easy. 

## Other  Hacks, Tips, and Tricks for Creating Digital Vision Boards:

If you want to create digital vision boards to print out, I highly recommend using [Google Docs](https://docs.google.com/).  You can add any image from the internet to a Google doc by copying and pasting. Arrangement isn’t as fluid as with Pinterest Shuffles, but bringing together a variety of pictures from different sources is so easy when using a Google doc—to me the experience is almost as close as one can get to cutting and pasting from a magazine. 

I can’t talk about digital vision boarding without mentioning [Canva](https://www.canva.com/). Canva is great if you would like for your vision board to be a desktop wallpaper. They have plenty of desktop wallpaper templates to choose from and arranging images is very easy.
...
# So Are You Struggling With Your Digital Vision Board? 

If you're having a hard time with making a digital vision board that works for you, it's usually because it's not aligned with what truly makes you feel alive, and it's not displayed somewhere you can see it every day. Thanks to this process, I now have a vision board that is inspiring and effective, and I hope these tips will help you to create a vision board that actually makes a difference.   
